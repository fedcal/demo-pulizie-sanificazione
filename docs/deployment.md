...
URL: `https://pulizie-sanificazione.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `pulizie-sanificazione.demo.federicocalo.dev`
...
- Output directory: `dist/pulizie-sanificazione/browser`
...
URL: `https://fedcal.github.io/federico-demo-pulizie-sanificazione/`
...
- `base: /federico-demo-pulizie-sanificazione/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `pulizie-sanificazione-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   pulizie-sanificazione-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `pulizie-sanificazione-docs.federicocalo.dev`
