...
hero:
  name: "Demo Pulizie e Sanificazione"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://pulizie-sanificazione.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-pulizie-sanificazione
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Pulizie e Sanificazione.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Pulizie e Sanificazione** in Italia.
...
Il mercato italiano delle PMI per **Pulizie e Sanificazione** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:pulizie-sanificazione
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-pulizie-sanificazione)
